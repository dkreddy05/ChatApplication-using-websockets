...
String field = ex.getBindingResult()
        ...
        FieldExceptionDetails details=new FieldExceptionDetails(new Date(),message,x.getDescription(false),field);
    ...
    public ResponseEntity<?>handleEmailAlreadyTakenException(EmailAlreadyTakenException ex,WebRequest x){
        ...
        String field="Email";
        FieldExceptionDetails details=new FieldExceptionDetails(new Date(),ex.getMessage(), x.getDescription(false), field);
    ...
    public ResponseEntity<?>handleConfirmationTokenNotFound(ConfirmationTokenNotFoundException ex,WebRequest x){
        ...
        FieldExceptionDetails details=new FieldExceptionDetails(new Date(),ex.getMessage(),x.getDescription(false),f);
    ...
    public ResponseEntity<?> handleEmailSendFailException(EmailSendFailException ex,WebRequest x){
        FieldExceptionDetails details=new FieldExceptionDetails(new Date(),ex.getMessage(), x.getDescription(false),"Email cannot Send");
