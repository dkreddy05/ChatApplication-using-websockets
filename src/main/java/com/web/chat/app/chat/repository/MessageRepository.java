package com.web.chat.app.chat.repository;
...
public interface MessageRepository extends JpaRepository<Message, Long> {
    ...
    @Query("SELECT m FROM Message m WHERE m.type = com.web.chat.app.chat.domain.MessageType.CHAT ORDER BY m.timeStamp ASC")
    Slice<Message> findGroupMessages(Pageable pageable);
